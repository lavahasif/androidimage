...
public class Print extends Thread {
    ...
    public void run(){
        ...
        try(TcpIpOutputStream stream = new TcpIpOutputStream(host, port)){
            ...
            Bitmap scaledBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.logotea, options);
            Bitmap bitmap = Bitmap.createScaledBitmap(scaledBitmap, 500, 250, true);
